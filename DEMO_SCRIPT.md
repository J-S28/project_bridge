...
## 2:30–4:00 — MP dashboard (the actual differentiator)
...
3. Scroll to the **department breakdown chart** and the **ward-by-ward comparison table** — *"One MP, multiple wards, compared side by side."*
...
> "Citizen, officer, department head, MLA, MP — one connected loop, with a real accountability hierarchy and an AI feature that actually answers the brief's question: not what people are complaining about, but what the data says to build next. It's live today at project-bridge-eight.vercel.app — thanks for watching."
...
4. **Never cut the priority-ranking panel** — it's the single highest-value thing to show, per the brief's own scoring criteria
